...
<div class="container-fluid">
	<div class="row header">
		...
		<div class="col-lg-10 judul text-left">
    		<h2>Peta Sebaran Kasus Covid-19 | Provinsi Bali</h2>
       	</div>
    ...
    <div class="row info2">
    	Sebaran Kasus Covid-19 di Provinsi Bali
    </div>
    ...
    <div class="row info">
            ...
            <h4>Filter Data</h4>
                ...
                <form action="/search" method="post" id="form">
                  ...
                  <div class="form-group">
                   ...
                   <button type="submit" class="btn btn-basic mb-2">Search</button>
        ...
        <div class="row info">
        	...
        	<div class="card" style="width: 80rem;">
              ...
              <div class="row">
                <div class="col-6">
                  Color Start
                  <input type="color" value="#080808" class="form-control" id="colorStart">
                </div>
                <div class="col-6">
                  Color End
              ...
              <div class="row mt-2">
                <div class="col-12">
                  <button class="btn btn-basic form-control" id="btnGenerateColor">Generate Color</button>
                </div>
    	...
    	<div class="row text col-lg-12">
            ...
            <div class="col-lg-6 text-right">Peta Sebaran Kasus Covid-19 Provinsi Bali Tahun 2020</div>
        </div>
